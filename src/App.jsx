...
function Header() {
  ...
  return (
    <header class="mb-8">
    <ul class="flex space-x-4 justify-end px-7 py-4">
        <li><a href="./pages/work.html" class="text-black hover:underline text-2xl">Work</a></li>
        <li><a href="./pages/blog.html" class="text-black hover:underline text-2xl">Blog</a></li>
        <li><a href="#" class="text-black hover:underline text-2xl">Contact</a></li>
    </ul>
</header>
  );
}
